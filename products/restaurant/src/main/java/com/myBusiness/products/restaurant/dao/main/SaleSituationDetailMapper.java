 ...
 * @since 2018-11-05
 */
public interface SaleSituationDetailMapper extends BaseMapper<SaleSituationDetailEntity> {
    ...
    * @return
    */
   public int updateSituation(SaleSituationService.SituationObj obj);
